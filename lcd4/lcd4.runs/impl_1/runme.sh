...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/lcd4/lcd4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd4.tcl -notrace
