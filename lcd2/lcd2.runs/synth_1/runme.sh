...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/lcd2/lcd2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd2.tcl
