...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/lcd2/lcd2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd2.tcl -notrace
