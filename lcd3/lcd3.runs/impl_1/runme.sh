...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/lcd3/lcd3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd3.tcl -notrace
