...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/lcd3/lcd3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lcd3.tcl
