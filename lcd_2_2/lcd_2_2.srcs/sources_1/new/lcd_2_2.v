module lcd_2_2(rst,clk,LCD_E,LCD_RS,LCD_RW,LCD_DATA,LED_out,number_btn,control_btn);
input rst,clk;
            ...
            CURSOR : begin
                if (cnt == 20) begin
                    case (control_btn)
                        ...
                        2'b01 : begin
                            if ({LCD_RS, LCD_RW, LCD_DATA} == 10'b0_0_1001_0101) begin //15
                                {LCD_RS, LCD_RW, LCD_DATA} = 10'b0_0_1100_0000; 
                            end else if ({LCD_RS, LCD_RW, LCD_DATA} == 10'b0_0_1101_0101) begin //55
