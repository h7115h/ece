...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/lcd_2_0/lcd_2_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lcd_2_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lcd_2_0.tcl -notrace
