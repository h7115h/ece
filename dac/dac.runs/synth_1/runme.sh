...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/dac/dac.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dac.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dac.tcl
