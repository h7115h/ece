...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/dac/dac.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dac.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dac.tcl -notrace
