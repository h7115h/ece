...
HD_PWD='C:/Users/user/Desktop/github/ece_exp2/dac2/dac2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dac2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dac2.tcl -notrace
